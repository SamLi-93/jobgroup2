...
/**
 * Auth 封装来自 sms_auth 数据表的记录及领域逻辑
 */
class Auth extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'admin_id' => array
                (
                    array('is_int', 'admin_id必须是一个整数'),

                ),

                'app' => array
                (
                    array('max_length', 50, 'app不能超过 50 个字符'),

                ),

                'perms' => array
                (
                    array('max_length', 50, 'perms不能超过 50 个字符'),
