...
/**
 * Activity 封装来自 activity 数据表的记录及领域逻辑
 */
class Activity extends QDB_ActiveRecord_Abstract
{
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                'activityname' => array
                (
                    array('not_empty', 'activityname不能为空'),
                    array('max_length', 128, 'activityname不能超过 128 个字符'),

                ),

                'actadmin' => array
                (
                    array('max_length', 128, 'actadmin不能超过 128 个字符'),

                ),

                'detail' => array
                (
                    array('max_length', 128, 'detail不能超过 128 个字符'),
